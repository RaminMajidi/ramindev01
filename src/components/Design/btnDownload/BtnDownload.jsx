...
const BtnDownload = ({size,text,href})=>{
    return(
    <a style={{border:"none"}} href={href} target={"_blank"} download> 
    <div data-tooltip={`Size: ${size}`} className="btnDownload">
       <div className="btnDownload-wrapper">
         <div className="btnDownload-text">{text}</div>
         <span className="btnDownload-icon">
