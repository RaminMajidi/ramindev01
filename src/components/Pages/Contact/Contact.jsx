...
const Contact = () =>{
    ...
    return(
        <section className="page col-12 col-lg-10 col-md-9 animate__animated animate__slideInRight" >
           <div className="neumorphism text-info d-flex justify-content-between align-items-start fs-1 p-3 w-75 mx-auto fw-bold"><h2>تماس بامن</h2><i class='bx bxs-user'></i></div>
