...
<header className={` header col-6 col-lg-2 col-md-3 ${show}`}>
 ...
 <div className=" w-100  position-relative">
    ...
    <hr/>
    <ul className=" nav-pills d-flex flex-column justify-content-around align-items-start mb-auto text-end">
      <li className="nav-item w-100 my-1" onClick={showMenu}>
        <Link to={"/"} className={`text-white nav-link ${activeMenu === "home" ? "active" : ""}`} aria-current="page">
        <i className='bx bxs-home m-2'></i>
          خانه
        </Link>
      </li>
      <li className="nav-item w-100 mb-1" onClick={showMenu}>
